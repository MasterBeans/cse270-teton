...
class TestSmokeTest():
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Vincent")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Jularbal")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("HandCrafted Haven")
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1536, 800)
